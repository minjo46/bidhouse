# ============================================================================
# 🏛️ [01-aws-seoul-network/waf.tf] AWS WAFv2 보안 대통합본
# ============================================================================
...
resource "aws_wafv2_web_acl" "alb" {
  ...
  # 어드민 경매 등록 (이미지 업로드) - WAF body 크기 제한 예외
  rule {
    name     = "AllowAdminAuctionUpload"
    priority = 5
    action {
      allow {}
    }
    ...
    visibility_config {
      ...
      metric_name                = "bidhouse-admin-auction-upload"
